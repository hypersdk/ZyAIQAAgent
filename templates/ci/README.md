...
Copy-paste starting points for running `zyvor-qa` as a QA gate in a CI system
...
All four run the published `ghcr.io/hypersdk/zyaiqaagent` container image
directly — no Python/Node/Playwright setup steps needed in your own pipeline.
The `v0.3.0` tag in each template should track whichever release you've
