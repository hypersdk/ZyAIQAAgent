...
If you own **pipelines, secrets, and "why is staging red?"**, this page is your map. The full checklists and copy-paste YAML live in the repo under [`docs/devops/`](https://github.com/hypersdk/zyvor-argus/tree/main/docs/devops) — this page is the summary.
...
Full runbook: [01 — CI/CD gate](https://github.com/hypersdk/zyvor-argus/blob/main/docs/devops/01-ci-cd-gate-runbook.md).
...
Full runbook: [02 — Secrets & target policy](https://github.com/hypersdk/zyvor-argus/blob/main/docs/devops/02-secrets-target-policy.md).
...
Full runbook: [03 — Feature specs](https://github.com/hypersdk/zyvor-argus/blob/main/docs/devops/03-feature-specs-product-repos.md).
...
Full runbook: [04 — Mission Control ops](https://github.com/hypersdk/zyvor-argus/blob/main/docs/devops/04-mission-control-ops.md).
...
Full runbook: [05 — Failure triage](https://github.com/hypersdk/zyvor-argus/blob/main/docs/devops/05-failure-triage-oncall.md).
...
Full runbook: [06 — Pipeline patterns](https://github.com/hypersdk/zyvor-argus/blob/main/docs/devops/06-pipeline-patterns.md).
